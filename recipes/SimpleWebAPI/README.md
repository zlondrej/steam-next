...
We are going to use `steam-next` and `flask` to build a Web API.
...
a modified version of the persistent login recipe that will talk with Steam.
  ...
  "apps": [
    {
      ...
      "appinfo": {
        ...
        "common": {
          ...
          "metacritic_fullurl": "https://www.metacritic.com/game/dota-2/?ftag=MCD-06-10aaa1f",
