...
class Util_Functions(unittest.TestCase):
    ...
    def test_ip6_from_bytes(self):
        ...
        self.assertEqual('1234:5678:9abc:def0:0:dead:beef:1',
    ...
    def test_ip6_to_bytes(self):
        ...
        self.assertEqual(ut.ip6_to_bytes('1:2:3:4:5:6:7:8'),
                         b'\x00\x01\x00\x02\x00\x03\x00\x04\x00\x05\x00\x06\x00\x07\x00\x08')
        self.assertEqual(ut.ip6_to_bytes('1234:5678:9abc:def0:0:dead:beef:1'),
...
class Util_Proto(unittest.TestCase):
    ...
    def test_proto_from_dict_to_dict(self):
        DATA = {'buffers': [
            ...
            'list_number32': [4, 16, 64, 256, 1024, 4096, 16384, 65536, 262144, 1048576, 4194304, 16777216, 67108864,
                              268435456, 1073741824],
            'list_number64': [4, 64, 1024, 16384, 262144, 1125899906842624, 18014398509481984, 288230376151711744,
                              4611686018427387904],
